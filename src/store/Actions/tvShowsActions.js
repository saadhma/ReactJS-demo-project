...
export function fetchTVShowsSeasonDetails(id, seasonNumber) {
    return {
...
export function fetchTVShowsSeasonRecommendations(id) {
    return {
      type: GET_TV_SHOWS_SEASON_RECOMMENDATIONS_REQUESTED,
      payload: id
    }
  }
