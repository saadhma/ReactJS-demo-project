...
import { fetchMovieCredits, fetchMovieDetails, fetchMovies } from '../../store/Actions/moviesActions';
...
export default function MovieDetailsScreen() {
    ...
    return (
        <div>
            ...
            <Grid container style={{ display: 'flex', width: '100%', paddingInline: '25px' }}>
                <Grid container style={{ width: '75%', flexDirection: 'row', }}>
                    <h2> Top Billed Cast </h2>
                    <HorizontalImageList moviesData={movieCreditsData.cast} />
                </Grid>
